...
import { useGetAllDepartments } from "@/hooks/post/useGetAllDepartmets";
...
export const TituloDepData = ({departmentId}: TituloDepartamentoDataProps) => {
    const { department, projects, isLoading, isError } = useGetDepartmentWithProjects(departmentId);
